...
WebUI.click(findTestObject('Payments/Refund/Customer Approval Refunds/Page_Dashboard  M-KOPAnet (1)/Approve Customer Refunds'))
...
WebUI.scrollToElement(findTestObject('Payments/Refund/Customer Approval Refunds/aprrovalstatus'), approvalStatus)
