...
WebUI.click(findTestObject('Payments/Customer Payments/Floating Payments/lnk_FloatingPayerPayment'))

WebUI.delay(2)

not_run: WebUI.verifyElementPresent(findTestObject(null), MDAZANFE9I0DF)
