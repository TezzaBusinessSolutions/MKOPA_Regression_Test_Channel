...
WebUI.click(findTestObject('Products/Payment Plans/Loan Payment Plan/Addloanpaymentplan/link_Approveloanpaymentplan'))
...
WebUI.verifyElementPresent(findTestObject('Products/Payment Plans/Loan Payment Plan/Disapproveloanpaymentplan/grid_loanpaymentplanslist'), 
    0)
